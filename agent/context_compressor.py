...
Write only the summary body. Do not include any preamble or prefix."""
    ...
    def _is_synthetic_compression_user_turn(cls, message: Any) -> bool:
        ...
        from agent.conversation_loop import (
            ...
            _ZERO_TOOL_TEXTUAL_CALL_NUDGE_CONTENT, _EMPTY_TOOL_RESPONSE_NUDGE,
            _LENGTH_CONTINUATION_DROPPED_TOOLS_PREFIX, _LENGTH_CONTINUATION_NETWORK_STUB,
        ...
        return text in {
            ...
            _DROPPED_TOOLCALL_NUDGE_CONTENT, _ZERO_TOOL_TEXTUAL_CALL_NUDGE_CONTENT,
            _EMPTY_TOOL_RESPONSE_NUDGE, _LENGTH_CONTINUATION_NETWORK_STUB,
            _LENGTH_CONTINUATION_OUTPUT_LIMIT,
        } or text.startswith((
